...
class CollapsingProfileHeaderView : LinearLayout {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs) {
        ...
        try {
            ...
            profileSubtitleTextSize = a.getResourceId(R.styleable.CollapsingProfileHeaderView_profileSubtitleTextSizeSp, 15)
            profileMiscTextSize = a.getResourceId(R.styleable.CollapsingProfileHeaderView_profileMiscTextSizeSp, 8)
        } finally {
            a.recycle()
        }
